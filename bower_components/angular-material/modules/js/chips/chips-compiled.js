...
(function (window, angular, undefined) {
  ...
  MdChipCtrl['$inject'] = ["$scope", "$element", "$mdConstant", "$timeout", "$mdUtil"];angular.module('material.components.chips').controller('MdChipCtrl', MdChipCtrl);
  ...
  MdChip['$inject'] = ["$mdTheming", "$mdUtil"];angular.module('material.components.chips').directive('mdChip', MdChip);
  ...
  MdChipsCtrl['$inject'] = ["$scope", "$attrs", "$mdConstant", "$log", "$element", "$timeout", "$mdUtil"];angular.module('material.components.chips').controller('MdChipsCtrl', MdChipsCtrl);
  ...
  MdChipsCtrl.prototype.configureUserInput = function (inputElement) {
    ...
    var scopeApplyFn = function scopeApplyFn(event, fn) {
  ...
  MdChips['$inject'] = ["$mdTheming", "$mdUtil", "$compile", "$log", "$timeout", "$$mdSvgRegistry"];angular.module('material.components.chips').directive('mdChips', MdChips);
  ...
  function MdChips($mdTheming, $mdUtil, $compile, $log, $timeout, $$mdSvgRegistry) {
    ...
    function compile(element, attr) {
      ...
      return function postLink(scope, element, attrs, controllers) {
        ...
        element.attr({ 'aria-hidden': true, tabindex: -1 }).on('focus', function () {
          mdChipsCtrl.onFocus();
        });
...
//# sourceMappingURL=chips-compiled.js.map