...
(function (window, angular, undefined) {
  ...
  function SelectDirective($mdSelect, $mdUtil, $mdConstant, $mdTheming, $mdAria, $parse, $sce, $injector) {
    ...
    return {
      ...
      compile: compile,
      controller: function controller() {} // empty placeholder controller to be initialized in link
    };
      ...
      return function postLink(scope, element, attr, ctrls) {
        ...
        attr.$observe('disabled', function (disabled) {
          ...
          if (disabled) {
            ...
            element.attr({ 'tabindex': attr.tabindex, 'aria-disabled': 'false' }).on('click', openSelect).on('keydown', handleKeypress);
          }
        });
