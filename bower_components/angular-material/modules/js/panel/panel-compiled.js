...
(function (window, angular, undefined) {
  ...
  MdPanelRef.prototype.open = function () {
    ...
    return this._$q(function (resolve, reject) {
      ...
      var checkGroupMaxOpen = function checkGroupMaxOpen() {
  ...
  MdPanelRef.prototype.attach = function () {
    ...
    return this._$q(function (resolve, reject) {
      ...
      var addListeners = function addListeners(response) {
  ...
  MdPanelRef.prototype.detach = function () {
    ...
    var detachFn = function detachFn() {
  ...
  MdPanelRef.prototype.show = function () {
    ...
    var self = this;
    var animatePromise = function animatePromise() {
    ...
    return this._$q(function (resolve, reject) {
      ...
      var addToGroupOpen = function addToGroupOpen() {
        if (self.config.groupName) {
          angular.forEach(self.config.groupName, function (group) {
  ...
  MdPanelRef.prototype.hide = function () {
    ...
    return this._$q(function (resolve, reject) {
      ...
      var removeFromGroupOpen = function removeFromGroupOpen() {
        if (self.config.groupName) {
          var group, index;
          angular.forEach(self.config.groupName, function (group) {
      ...
      var focusOnOrigin = function focusOnOrigin() {
  ...
  MdPanelRef.prototype.addClass = function (newClass, toElement) {
    this._$log.warn('mdPanel: The addClass method is in the process of being deprecated. ' + 'Full deprecation is scheduled for the Angular Material 1.2 release. ' + 'To achieve the same results, use the panelContainer or panelEl ' + 'JQLite elements that are referenced in MdPanelRef.');
  ...
  MdPanelRef.prototype.removeClass = function (oldClass, fromElement) {
    this._$log.warn('mdPanel: The removeClass method is in the process of being deprecated. ' + 'Full deprecation is scheduled for the Angular Material 1.2 release. ' + 'To achieve the same results, use the panelContainer or panelEl ' + 'JQLite elements that are referenced in MdPanelRef.');
  ...
  MdPanelRef.prototype.toggleClass = function (toggleClass, onElement) {
    this._$log.warn('mdPanel: The toggleClass method is in the process of being deprecated. ' + 'Full deprecation is scheduled for the Angular Material 1.2 release. ' + 'To achieve the same results, use the panelContainer or panelEl ' + 'JQLite elements that are referenced in MdPanelRef.');
    ...
    return this._$q(function (resolve, reject) {
      ...
      self._compile().then(function () {
        if (self.config['disableParentScroll']) {
          self._restoreScroll = self._$mdUtil.disableScrollAround(null, self.panelContainer, { disableScrollMask: true });
        }
  ...
  MdPanelRef.prototype._addStyles = function () {
    ...
    return this._$q(function (resolve) {
      ...
      var hideAndResolve = function hideAndResolve() {
  ...
  */
  ...
  MdPanelRef.prototype._animateOpen = function () {
    ...
    return this._$q(function (resolve) {
      var done = self._done(resolve, self);
      var warnAndOpen = function warnAndOpen() {
  ...
  MdPanelRef.prototype._animateClose = function () {
    ...
    return this._$q(function (resolve) {
      ...
      var warnAndClose = function warnAndClose() {
  ...
  MdPanelRef.prototype.registerInterceptor = function (type, callback) {
    ...
    if (!angular.isString(type)) {
      error = 'Interceptor type must be a string, instead got ' + (typeof type === "undefined" ? "undefined" : _typeof(type));
    } else if (!angular.isFunction(callback)) {
      error = 'Interceptor callback must be a function, instead got ' + (typeof callback === "undefined" ? "undefined" : _typeof(callback));
    }
  ...
  */
  ...
  MdPanelPosition.prototype.addPanelPosition = function (xPosition, yPosition) {
    if (!this._relativeToEl) {
      throw new Error('mdPanel: addPanelPosition can only be used with ' + 'relative positioning. Set relativeTo first.');
    }
