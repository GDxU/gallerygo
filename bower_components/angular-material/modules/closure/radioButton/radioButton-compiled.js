...
function mdRadioGroupDirective($mdUtil, $mdConstant, $mdTheming, $timeout) {
  ...
  function createRadioGroupControllerProto() {
    return {
      ...
      add: function add(rbRender) {
        this._radioButtonRenderFns.push(rbRender);
      },
      remove: function remove(rbRender) {
      ...
      setViewValue: function setViewValue(value, eventType) {
      ...
      setActiveDescendant: function setActiveDescendant(radioId) {
  ...
  function changeSelectedButton(parent, increment) {
    ...
    if (buttons.count()) {
      var validate = function validate(button) {
...
//# sourceMappingURL=radioButton-compiled.js.map