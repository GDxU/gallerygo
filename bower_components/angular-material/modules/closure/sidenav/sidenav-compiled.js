...
function SidenavFocusDirective() {
  return {
    restrict: 'A',
    require: '^mdSidenav',
    link: function link(scope, element, attr, sidenavCtrl) {
  ...
  function postLink(scope, element, attr, sidenavCtrl) {
    ...
    if (attr.mdDisableScrollTarget) {
      ...
      if (disableScrollTarget) {
        ...
        $log.warn($mdUtil.supplant('mdSidenav: couldn\'t find element matching ' + 'selector "{selector}". Falling back to parent.', { selector: attr.mdDisableScrollTarget }));
      }
    }
