...
(function (window, angular, undefined) {
   ...
   *
   */
  angular.module('ngMaterial-mock', ['ngMock', 'ngAnimateMock', 'material.core']).config(['$provide', function ($provide) {

    $provide.factory('$material', ['$animate', '$timeout', function ($animate, $timeout) {
      return {
        flushOutstandingAnimations: function flushOutstandingAnimations() {
        ...
        flushInterimElement: function flushInterimElement() {
  ...
  window.createMockStyleSheet = function createMockStyleSheet(doc, wind) {
    ...
    return {
      addRule: function addRule(selector, styles) {
...
//# sourceMappingURL=angular-material-mocks-compiled.js.map