  ...
  var c = "BUTTON A INPUT TEXTAREA SELECT DETAILS SUMMARY".split(" "),
    ...
    function a(a, c, n, k) {
      return function (d, f, e) {
        var g = e.$normalize(c);!b[g] || h(f, n) || e[g] || d.$watch(e[a], function (a) {
          a = k ? !a : !!a;f.attr(c, a);
        });
      };
    ...
    }return { restrict: "A", require: "ngModel", priority: 200, compile: function compile(c, k) {
        var d = m(k, c);return { post: function post(f, e, g, c) {
            function k() {
              return c.$modelValue;
            }function h(a) {
              ...
              e.attr("aria-checked", !c.$isEmpty(c.$viewValue));
            }var n = b("tabindex", "tabindex", e, !1);switch (d) {case "radio":case "checkbox":
                l(d, e) && e.attr("role", d);b("aria-checked", "ariaChecked", e, !1) && f.$watch(k, "radio" === d ? h : m);n && e.attr("tabindex", 0);break;case "range":
                l(d, e) && e.attr("role", "slider");if (a.config("ariaValue")) {
                  var p = !e.attr("aria-valuemin") && (g.hasOwnProperty("min") || g.hasOwnProperty("ngMin")),
                      ...
                      r = !e.attr("aria-valuenow");p && g.$observe("min", function (a) {
                ...
                }n && e.attr("tabindex", 0);}!g.hasOwnProperty("ngRequired") && c.$validators.required && b("aria-required", "ariaRequired", e, !1) && g.$observe("required", function () {
    ...
    return { restrict: "A", require: "?ngMessages", link: function link(a, b, c, h) {
        b.attr("aria-live") || b.attr("aria-live", "assertive");
      } };
  }).directive("ngClick", ["$aria", "$parse", function (a, b) {
    return { restrict: "A", compile: function compile(l, m) {
        var n = b(m.ngClick, null, !0);return function (b, d, f) {
          if (!h(d, c) && (a.config("bindRoleForClick") && !d.attr("role") && d.attr("role", "button"), a.config("tabindex") && !d.attr("tabindex") && d.attr("tabindex", 0), a.config("bindKeydown") && !f.ngKeydown && !f.ngKeypress && !f.ngKeyup)) d.on("keydown", function (a) {
            function c() {
              n(b, { $event: a });
            }var d = a.which || a.keyCode;32 !== d && 13 !== d || b.$apply(c);
          });
        };
      } };
