...
(function (I, d) {
  ...
  function A(d) {
    ...
    return { restrict: "ECA", terminal: !0, priority: 400, transclude: "element", link: function link(a, f, b, c, m) {
        function v() {
          p && (g.cancel(p), p = null);l && (l.$destroy(), l = null);n && (p = g.leave(n), p.done(function (a) {
            !1 !== a && (p = null);
          }), n = null);
        }function D() {
          var b = t.current && t.current.locals;if (d.isDefined(b && b.$template)) {
            var b = a.$new(),
                c = t.current;n = m(b, function (b) {
            ...
            p,
            w = b.autoscroll,
            k = b.onload || "";a.$on("$routeChangeSuccess", D);D();
      } };
  }function x(d, k, g) {
    ...
    function t(a, f) {
      ...
      var b;b = void 0;if (y(f)) {
        b = b || [];for (var c = 0, m = f.length; c < m; c++) {
          b[c] = f[c];
        }
      } else if (E(f)) for (c in b = b || {}, f) {
      ...
      function l(e) {
        var h = q.current;(y = (s = B()) && h && s.$$route === h.$$route && d.equals(s.pathParams, h.pathParams) && !s.reloadOnSearch && !C) || !h && !s || a.$broadcast("$routeChangeStart", s, h).defaultPrevented && e && e.preventDefault();
      }function n() {
        var e = q.current,
            h = s;if (y) e.params = h.params, d.copy(e.params, b), a.$broadcast("$routeUpdate", e);else if (h || e) {
          C = !1;q.current = h;var G = c.resolve(h);G.then(p).then(w).then(function (c) {
        ...
        var b = !0;if (a.route !== q.current) b = !1;else if (a.hasRedirection) {
          var d = f.url(),
              c = a.url;c ? f.url(c).replace() : c = f.path(a.path).search(a.search).replace().url();
          c !== d && (b = !1);
        }return b;
      }function z(a) {
        if (a) {
          ...
          });a = A(a);d.isDefined(a) && (b.$template = a);return c.all(b);
        }
      }function A(a) {
        ...
        reload: function reload() {
          C = !0;var b = { defaultPrevented: !1, preventDefault: function preventDefault() {
              this.defaultPrevented = !0;C = !1;
            } };a.$evalAsync(function () {
            l(b);b.defaultPrevented || n();
          });
        }, updateParams: function updateParams(a) {
          if (this.current && this.current.$$route) a = d.extend({}, this.current.params, a), f.path(x(this.current.$$route.originalPath, a)), f.search(a);else throw H("norout");
  ...
  });z.directive("ngView", B);z.directive("ngView", x);B.$inject = ["$route", "$anchorScroll", "$animate"];x.$inject = ["$compile", "$controller", "$route"];
