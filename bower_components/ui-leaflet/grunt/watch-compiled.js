...
var _files = ['src/**/*.js'];
var _testFiles = ['test/unit/**.js', 'test/unit/**.coffee', 'test/e2e/**.js', 'test/unit/**/**.js', 'test/unit/**/**.coffee', 'test/e2e/**/**.js'];
...
module.exports = function (grunt, options) {
    return {
        ...
        fast: {
            files: _files,
            tasks: ['fastbuild', 'uglify', 'concat:license']
        },
        source: {
            files: _files,
            tasks: ['fastbuild', 'uglify', 'testunit', 'concat:license']
        },
        unit: {
            files: _testFiles,
            tasks: ['fastbuild', 'karma']
        },
        examples: {
            files: ['examples/*.html'],
            tasks: ['examples']
