...
(function () {
   ...
   */
  var toPixels = function toPixels(widthValue) {
    var px;
    switch (widthValue) {
      case "thin":
        px = "2px";
   ...
   */
  var getBorderWidths = function getBorderWidths(h) {
    var computedStyle;
    var bw = {};
  ...
  var getScrollValue = function getScrollValue(e) {
   ...
   * @return {Object} The position object {left, top}.
   */
  var getElementPosition = function getElementPosition(h) {
   ...
   */
  var setVals = function setVals(obj, vals) {
    if (obj && vals) {
      for (var x in vals) {
   ...
   */
  var setOpacity = function setOpacity(h, op) {
...
//# sourceMappingURL=keydragzoom-compiled.js.map